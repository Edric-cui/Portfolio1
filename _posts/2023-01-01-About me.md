...
![Agile workflow overview showing the Figma-to-agent feedback loop used to iterate this portfolio quickly.]({{site.baseurl}}/assets/images/agile-workflow.jpg){:class="img-responsive"}
